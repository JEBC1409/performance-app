...
const VARIANT: Record<Variant, string> = {
  ...
  primary:
    "btn-primary text-white border border-[rgb(var(--accent-light-rgb)/0.5)] shadow-[0_1px_0_rgba(255,255,255,0.35)_inset,0_-6px_10px_-6px_rgba(0,0,0,0.45)_inset,0_10px_28px_-10px_rgb(var(--accent-rgb)/0.8)] hover:shadow-[0_1px_0_rgba(255,255,255,0.4)_inset,0_-6px_10px_-6px_rgba(0,0,0,0.45)_inset,0_14px_32px_-10px_rgb(var(--accent-rgb)/0.9)] active:brightness-95 active:translate-y-px active:scale-[0.99]",
